...
function voyage_grid_class() {
	...
	if ( '2' == $voyage_options['blog_layout'] && ( $voyage_options['column_sidebar1'] > 0 || $voyage_options['column_sidebar2'] > 0 ) ) {
	...
	elseif ( '3' == $voyage_options['blog_layout'] && $voyage_options['column_sidebar1'] > 0 ) {
		$push_col = $voyage_options['column_sidebar1']; 
		$class = $class . "push_" . $push_col . ' ';		
	}
	return $class;
...
function voyage_carousel_class() {
	...
	$class = 'slide';
	if ( 1 == $voyage_options['fp_effect'] )
		$class = '';
	elseif ( 3 == $voyage_options['fp_effect'] 
...
if ( ! function_exists( 'voyage_bbp_class' ) ) :
/** return grid class for bbPress & BuddyPress page */
function voyage_bbp_class() {
    global $voyage_options;

	$class = "grid_" . $voyage_options['bbp_column1'] . ' ' ;
	if ( 1 == $voyage_options['bbp_position'] && $voyage_options['bbp_column2'] > 0 ) {
			$push_col = $voyage_options['bbp_column2']; 	
		$class = $class . "push_" . $push_col . ' ';
	}
