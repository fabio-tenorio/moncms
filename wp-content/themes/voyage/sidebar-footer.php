...
<?php
	...
	if ( is_active_sidebar( 'second-footer-widget-area' ) && $voyage_options['column_footer2'] > 0) { ?>
...
<?php
	...
	if ( is_active_sidebar( 'third-footer-widget-area' ) && $voyage_options['column_footer3'] ) { ?>
...
<?php
	...
	if ( is_active_sidebar( 'fourth-footer-widget-area' ) && $voyage_options['column_footer4'] ) { ?>
