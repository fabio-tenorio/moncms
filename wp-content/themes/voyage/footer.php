...
<div id="footer" role="contentinfo">
	<div class="<?php echo voyage_container_class(); ?> clearfix">
		...
		<div id="site-generator" class="<?php echo voyage_grid_half(); ?>">
			...
			<?php _e(' | ', 'voyage') ;?>
			<a href="<?php echo esc_url(__('http://www.rewindcreation.com/voyage/','voyage')); ?>" title="<?php esc_attr_e('Voyage Theme by Stephen Cui', 'voyage'); ?>"><?php esc_attr_e('Voyage Theme', 'voyage'); ?></a>		
		</div><!-- #site-generator -->
